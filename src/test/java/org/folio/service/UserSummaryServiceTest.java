...
//
//    userSummaryService.updateUserSummary(userSummary, feeFineBalanceChangedEvent);
//
//    await().until(() ->
...
//    userSummaryService.updateUserSummary(userSummary, itemCheckedOutEvent);
//
//    ItemAgedToLostEvent itemAgedToLostEvent = buildItemAgedToLostEvent(userId, loanId);
//    waitFor(userSummaryService.updateUserSummary(userSummary, itemAgedToLostEvent));
//
...
//    waitFor(userSummaryService.updateUserSummary(userSummary, loanDueDateChangedEvent));
...
//      waitFor(userSummaryService.updateUserSummary(userSummary, feeFineBalanceChangedEvent));
...
//        waitFor(
//          userSummaryService.updateUserSummary(userSummaryAfterFirstUpdate, feeFineBalanceChangedEvent));
...
//    waitFor(userSummaryService.updateUserSummary(userSummary, feeFineBalanceChangedEvent1));
//    waitFor(userSummaryService.updateUserSummary(userSummary, feeFineBalanceChangedEvent2));
