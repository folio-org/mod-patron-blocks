...
public class ModuleInfo {
  ...
  public static String moduleVersion() {
    try (var stream = ModuleInfo.class.getResourceAsStream(MODULE_VERSION_RESOURCE)) {
      if (stream == null) {
        throw new IllegalStateException("Missing module version resource: " + MODULE_VERSION_RESOURCE);
      }
      ...
      throw new UncheckedIOException("Failed to read module version from " + MODULE_VERSION_RESOURCE, e);
    }
  }
}
